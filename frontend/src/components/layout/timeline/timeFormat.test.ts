...
assertEqual(formatBarBeatsLabel(1.1166666666, 4), "1.2.116..", "subdivision truncates to three digits");
assertEqual(formatBarBeatsLabel(0.875, 4, "cursor"), "1.1.875", "cursor keeps exact thousandths");
assertEqual(formatBarBeatsLabel(0.0625, 4, "cursor"), "1.1.062", "cursor 64th truncation");
assertEqual(formatBarBeatsLabel(1.1166666666, 4, "cursor"), "1.2.116", "cursor truncates to three digits");
...
assertEqual(formatBarBeatsLabel(3.9996, 4, "cursor"), "1.4.999", "cursor truncates near-bar value");
...
assertNear(
    gridDivisionsPerBar("1/4d", 4),
    8 / 3,
    "dotted grid fractional divisions",
);
assertEqual(
...
// ── 自适应刻度 ───────────────────────────────────────────────────
assertEqual(selectRulerStep({ pxPerBeat: 75, grid: "1/4", beatsPerBar: 4, minLabelSpacingPx: 90 }), 2, "default zoom half note");
assertEqual(selectRulerStep({ pxPerBeat: 120, grid: "1/4", beatsPerBar: 4, minLabelSpacingPx: 90 }), 1, "quarter note");
assertEqual(selectRulerStep({ pxPerBeat: 240, grid: "1/8", beatsPerBar: 4, minLabelSpacingPx: 90 }), 0.5, "eighth note");
assertEqual(selectRulerStep({ pxPerBeat: 480, grid: "1/16", beatsPerBar: 4, minLabelSpacingPx: 90 }), 0.25, "sixteenth note");
assertEqual(selectRulerStep({ pxPerBeat: 960, grid: "1/32", beatsPerBar: 4, minLabelSpacingPx: 90 }), 0.125, "32nd note");
assertEqual(selectRulerStep({ pxPerBeat: 2000, grid: "1/4", beatsPerBar: 4, minLabelSpacingPx: 90 }), 1, "grid caps precision at 1/4");
assertEqual(selectRulerStep({ pxPerBeat: 2000, grid: "1/32", beatsPerBar: 4, minLabelSpacingPx: 90 }), 0.125, "grid caps precision at 1/32");
assertEqual(selectRulerStep({ pxPerBeat: 2000, grid: "1/64", beatsPerBar: 4, minLabelSpacingPx: 90 }), 0.0625, "64th grid precision");
assertEqual(selectRulerStep({ pxPerBeat: 2000, grid: "1/8t", beatsPerBar: 4, minLabelSpacingPx: 90 }), 1 / 3, "triplet grid precision");
assertEqual(selectRulerStep({ pxPerBeat: 2000, grid: "1/16t", beatsPerBar: 4, minLabelSpacingPx: 90 }), 1 / 6, "16th triplet grid precision");
assertEqual(selectRulerStep({ pxPerBeat: 40, grid: "1/4", beatsPerBar: 4, minLabelSpacingPx: 90 }), 4, "zoom out keeps bar when it still fits");
...
assertEqual(
    rulerStepCandidates("1/8t", 4)[0],
    1 / 3,
    "triplet candidates include grid step",
);
assertEqual(
