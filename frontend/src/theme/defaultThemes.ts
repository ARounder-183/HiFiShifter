...
export const DARK_THEME_COLORS: Record<QtColorToken, string> = {
    ...
    "qt-clip-selected-border": "rgba(24,28,35,0.95)",
    "qt-text": "#d0d0d0",
    ...
    "qt-graph-bg": "#1f1f1f",
    "qt-graph-grid-strong": "rgba(255,255,255,0.22)",
    "qt-graph-grid-weak": "rgba(255,255,255,0.10)",
...
export const LIGHT_THEME_COLORS: Record<QtColorToken, string> = {
    ...
    "qt-graph-bg": "#edf0f5",
    "qt-graph-grid-strong": "rgba(74,88,112,0.55)",
    "qt-graph-grid-weak": "rgba(74,88,112,0.30)",
