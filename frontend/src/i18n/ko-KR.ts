export const koKR = {
    ...
    export_dialog_format: "출력 포맷",
    export_dialog_encoder_params: "인코더 설정",
    export_dialog_mp3_mode: "인코딩 모드",
    export_dialog_mp3_mode_vbr: "VBR(품질 우선)",
    export_dialog_mp3_mode_cbr: "CBR(고정 비트레이트)",
    export_dialog_mp3_bitrate: "비트레이트",
    export_dialog_mp3_quality: "VBR 품질",
    export_dialog_mp3_tags: "메타데이터(ID3 태그)",
    export_dialog_tag_title: "제목",
    export_dialog_tag_artist: "아티스트",
    export_dialog_tag_album: "앨범",
    export_dialog_tag_comment: "메모",
    export_dialog_mp3_bit_depth_note: "MP3는 내부적으로 16-bit 상당 입력으로 인코딩합니다.",
    export_dialog_flac_level: "압축 레벨",
    export_dialog_flac_level_hint: "0 = 가장 빠름, 8 = 가장 작은 파일.",
    export_dialog_dither: "디더",
    export_dialog_dither_none: "끄기",
    export_dialog_dither_tpdf: "TPDF",
    export_dialog_channel_mode: "채널",
    export_dialog_channel_stereo: "스테레오",
    ...
    export_dialog_error_mp3_unsupported_sample_rate:
        "이 샘플 레이트는 MP3에서 지원하지 않습니다. 8kHz~48kHz 사이의 MPEG 지원 값을 사용하세요.",
    ...
    layout_settings_hint:
        "탭을 드래그해 패널을 재배치합니다. 도킹 보조키를 누르면 플로팅 대신 도킹합니다.",
    layout_setting_dock_modifier: "도킹 보조키",
    layout_setting_dock_modifier_hint:
        "탭을 드래그할 때 누르고 있으면 플로팅 대신 도킹을 우선합니다.",
    layout_modifier_primary: "Ctrl / Cmd",
    layout_modifier_alt: "Alt",
    layout_modifier_shift: "Shift",
    layout_modifier_none: "항상 도킹",
    layout_setting_edge_band: "가장자리 도킹 감도",
    layout_setting_show_preview: "드롭 위치 미리보기 표시",
    layout_setting_tab_bar_single: "항상 탭 바 표시",
    layout_setting_tab_icons: "탭에 아이콘 표시",
    layout_setting_double_click: "탭 더블 클릭",
    layout_dc_float: "플로팅 / 도킹",
    layout_dc_maximize: "최대화",
    layout_dc_collapse: "접기",
    layout_dc_none: "아무것도 안 함",
    layout_setting_float_snap: "플로팅 창 스냅",
    layout_setting_snap_px: "스냅 거리",
    layout_setting_restore_floats: "시작 시 플로팅 창 복원",
    layout_setting_startup: "시작 시 레이아웃",
    layout_startup_last: "마지막 사용",
    layout_setting_confirm_reset: "초기화 전 확인",
    layout_setting_tab_position: "탭 줄 위치",
    layout_tab_position_bottom: "아래(기본)",
    layout_tab_position_top: "위",
    layout_setting_save_delay: "레이아웃 저장 지연",
    layout_unit_ms: "ms",
    layout_unit_px: "px",
    kb_group_layout: "레이아웃",
    kb_layout_toggle_float: "포커스 패널 플로팅/도킹",
    kb_layout_next_panel: "다음 패널로 포커스",
    kb_layout_prev_panel: "이전 패널로 포커스",
    kb_layout_maximize: "포커스 패널 최대화/복원",
    notebook: "노트",
    notebook_placeholder: "현재 프로젝트 메모를 여기에 적으세요...",
    notebook_mode_rich: "리치 텍스트",
    notebook_mode_source: "Markdown 소스",
    notebook_mode_split: "분할",
    ...
    notebook_project_info_value: "값",
    notebook_project_info_name: "프로젝트",
    notebook_project_info_bpm: "BPM",
    notebook_project_info_scale: "기준 스케일",
    notebook_project_info_date: "날짜",
    notebook_clipboard_unavailable: "클립보드에 HiFiShifter 데이터가 없습니다",
    notebook_clipboard_staged: "클립보드 데이터를 노트에 임시 저장했습니다",
    notebook_toolbar_heading1: "제목 1",
    notebook_toolbar_heading2: "제목 2",
    notebook_toolbar_heading3: "제목 3",
    notebook_toolbar_paragraph: "본문",
    notebook_toolbar_bold: "굵게(Ctrl+B)",
    notebook_toolbar_italic: "기울임꼴(Ctrl+I)",
    notebook_toolbar_strike: "취소선",
    notebook_toolbar_inline_code: "인라인 코드",
    notebook_toolbar_bullet_list: "글머리 기호 목록",
    notebook_toolbar_ordered_list: "번호 매기기 목록",
    notebook_toolbar_task_list: "작업 목록",
    notebook_toolbar_quote: "인용",
    notebook_toolbar_code_block: "코드 블록",
    notebook_toolbar_link: "링크(Ctrl+K)",
    notebook_toolbar_image: "이미지 삽입",
    notebook_toolbar_table: "표 삽입",
    notebook_toolbar_rule: "가로줄",
    notebook_toolbar_timecode: "재생 헤드 시간 삽입",
    notebook_toolbar_clip_ref: "클립 참조 삽입",
    notebook_toolbar_stage_clipboard: "클립보드 데이터 임시 저장",
    notebook_toolbar_project_info: "프로젝트 정보 삽입",
    notebook_link_prompt: "링크 주소",
    notebook_clip_invalid: "이 임시 저장 블록은 형식이 잘못되었습니다(id 누락). 소스로 표시합니다",
    notebook_clip_actions: "작업",
    notebook_clip_kind_clips: "클립",
    notebook_clip_kind_tracks: "트랙",
    notebook_clip_kind_project: "프로젝트",
    notebook_clip_kind_param: "파라미터",
    notebook_clip_restore: "클립보드로 복원",
    notebook_clip_insert_timeline: "타임라인에 삽입",
    notebook_clip_insert_new_tracks: "새 트랙으로 삽입",
    notebook_clip_rename: "이름 바꾸기",
    notebook_clip_copy_markdown: "Markdown으로 복사",
    ...
    notebook_clip_missing_payload:
        "임시 저장된 페이로드가 없습니다(첨부 파일 삭제됨). 복원과 삽입을 사용할 수 없습니다.",
    notebook_clip_restored: "시스템 클립보드로 복원했습니다",
    notebook_clip_inserted: "타임라인으로 보냈습니다",
    notebook_clip_action_failed: "작업 실패",
    notebook_clip_from: "출처",
    notebook_clip_unit_clips: "클립",
    notebook_clip_unit_tracks: "트랙",
    notebook_clip_unit_frames: "프레임",
    notebook_image_missing: "이미지를 찾을 수 없습니다",
    notebook_image_loading: "이미지 불러오는 중...",
    notebook_crash_title: "노트를 불러오지 못했습니다",
    notebook_crash_hint:
        "노트 내용은 그대로 남아 있습니다. Markdown 소스 보기로 전환해 확인하거나 복사하고, 패널을 닫은 뒤 다시 시도해 보세요.",
    notebook_crash_open_source: "Markdown 소스로 열기",
    notebook_image_insert_failed: "이미지를 삽입하지 못했습니다",
    notebook_image_too_large: "이미지가 너무 커서 크기 제한을 초과했습니다",
    notebook_image_undecodable: "이미지를 디코딩할 수 없습니다",
    notebook_image_read_failed: "이미지 파일을 읽지 못했습니다",
    notebook_image_save_failed: "이미지를 저장하지 못했습니다",
    notebook_paste_nothing: "클립보드에 붙여넣을 내용이 없습니다",
    notebook_error_bad_base64: "첨부 데이터가 올바른 base64가 아닙니다",
    notebook_error_not_a_file: "해당 경로는 일반 파일이 아닙니다",
    notebook_error_unsupported_image_ext: "지원하지 않는 이미지 형식입니다",
    notebook_error_export_mkdir_failed: "내보내기 폴더를 만들지 못했습니다",
    notebook_image_missing_hint:
        "첨부 파일이 없습니다. 삭제를 실행 취소하거나 이미지를 다시 삽입하세요.",
    notebook_image_copy: "이미지 복사",
    notebook_image_save_as: "이미지를 다른 이름으로 저장...",
    ...
    notebook_find_prev: "이전 항목",
    notebook_find_next: "다음 항목",
    notebook_status_characters: "자",
    notebook_status_images: "이미지",
    notebook_status_clips: "임시 저장",
    notebook_status_unsaved: "저장되지 않음",
    notebook_status_saved: "저장됨",
    notebook_attachments_empty: "이 프로젝트에는 아직 첨부 파일이 없습니다.",
    notebook_attachments_clean: "사용하지 않는 항목 제거",
    notebook_attachments_clean_hint: "노트에서 더 이상 참조하지 않는 첨부 파일을 삭제합니다",
    notebook_attachments_cleaned: "정리했습니다",
    notebook_attachments_used: "사용 중",
    notebook_attachments_unused: "사용 안 함",
    notebook_attachments_save_as: "다른 이름으로 저장...",
    notebook_attachments_removed: "첨부 파일을 제거했습니다",
    notebook_settings_group_view: "보기 및 편집",
    notebook_settings_group_image: "이미지",
    notebook_settings_group_clipboard: "클립보드",
    notebook_settings_group_clip_block: "클립보드 임시 저장 블록",
    notebook_settings_group_export: "내보내기",
    notebook_setting_default_mode: "기본 보기",
    notebook_setting_toolbar: "서식 도구 모음 표시",
    notebook_setting_markdown_shortcuts: "Markdown 입력 단축키",
    ...
    notebook_setting_image_max_dim: "이미지 최대 변",
    notebook_setting_image_max_dim_original: "원본",
    notebook_setting_image_format: "이미지 형식",
    notebook_setting_image_format_auto: "자동",
    notebook_setting_remote_images: "원격 이미지 불러오기",
    notebook_setting_smart_paste: "스마트 붙여넣기",
    notebook_setting_html_paste: "리치 텍스트 붙여넣기 형식",
    notebook_setting_plain_paste: "일반 텍스트 붙여넣기 형식",
    notebook_setting_plain_paste_auto: "Markdown 자동 감지",
    notebook_setting_paste_text: "일반 텍스트",
    notebook_setting_copy_format: "복사 형식",
    notebook_setting_copy_format_both: "Markdown + HTML",
    notebook_setting_copy_plain: "일반 텍스트 형식",
    notebook_setting_copy_plain_markdown: "Markdown 소스",
    notebook_setting_clip_insert_mode: "임시 저장 클립 삽입 위치",
    ...
    notebook_setting_keep_clip: "삽입 후 임시 저장 블록 유지",
    notebook_setting_clip_preview: "임시 저장 블록 안에 미리보기 표시",
    notebook_export_md: "Markdown으로 내보내기",
    notebook_export_running: "내보내는 중...",
    notebook_export_done: "내보냈습니다",
    notebook_export_failed: "내보내기 실패",
    notebook_export_missing: "첨부 파일 누락",
    notebook_export_html: "HTML로 내보내기",
    ...
    status_playing_original: "오리지널 재생 중",
    status_play_original_failed: "오리지널 재생에 실패했습니다",
    status_stopping_audio: "오디오 정지 중...",
    status_audio_stopped: "오디오가 정지되었습니다",
    status_stop_audio_failed: "오디오 정지에 실패했습니다",
    status_audio_imported: "오디오를 가져왔습니다",
    status_dropped_audio_imported: "드롭한 오디오를 가져왔습니다",
    status_clips_duplicated: "클립을 복제했습니다",
    status_clip_edit_rejected: "클립 편집이 거부되었습니다",
    status_import_done: "가져오기 완료",
    status_import_failed: "가져오기 실패",
    status_project_imported: "프로젝트를 가져왔습니다",
    status_vocalshifter_project_imported: "VocalShifter 프로젝트를 가져왔습니다",
    status_reaper_project_imported: "REAPER 프로젝트를 가져왔습니다",
    status_pasted_vocalshifter_clipboard: "VocalShifter 클립보드 데이터를 붙여넣었습니다",
    status_pasted_reaper_clipboard: "REAPER 클립보드 데이터를 붙여넣었습니다",
    status_timeline_clipboard_pasted: "타임라인 클립보드를 붙여넣었습니다",
    status_paste_timeline_failed: "타임라인 클립보드 붙여넣기에 실패했습니다",
    status_tempo_map_updated: "템포 맵이 업데이트되었습니다",
    status_waiting_import_options: "가져오기 옵션 대기 중...",
    status_waveform_cache_cleared: "파형 캐시를 삭제했습니다 ({n}개)",
    status_take_switch_rejected: "테이크 전환이 거부되었습니다",
    status_take_cycle_rejected: "테이크 순환 전환이 거부되었습니다",
    status_take_reverse_rejected: "테이크 역방향 재생이 거부되었습니다",
    status_add_take_failed: "미디어에서 테이크 추가에 실패했습니다",
    status_duplicate_take_failed: "테이크 복제에 실패했습니다",
    status_explode_takes_failed: "테이크 분할에 실패했습니다",
    status_pack_takes_failed: "테이크 통합에 실패했습니다",
    status_remove_take_failed: "테이크 삭제에 실패했습니다",
    status_rename_take_failed: "테이크 이름 바꾸기에 실패했습니다",
    status_applying_pitch_shift: "피치 시프트 적용 중...",
    status_clearing_waveform_cache: "파형 캐시 삭제 중...",
    status_exporting_wav: "WAV 내보내는 중...",
    status_exporting_audio: "오디오 내보내는 중...",
    status_exporting_separated: "트랙별로 내보내는 중...",
    status_importing_midi: "MIDI 클립 가져오는 중...",
    status_importing_reaper: "REAPER 프로젝트 가져오는 중...",
    status_importing_vocalshifter: "VocalShifter 프로젝트 가져오는 중...",
    status_importing_audio: "오디오 가져오는 중...",
    status_importing_dropped: "드롭한 오디오 가져오는 중...",
    status_importing_multiple: "여러 오디오 파일 가져오는 중...",
    status_importing_project: "프로젝트 가져오는 중...",
    status_loading_default_model: "기본 모델 로드 중...",
    status_loading_model: "모델 로드 중...",
    status_pasting_reaper: "REAPER 클립보드 데이터 붙여넣는 중...",
    status_pasting_vocalshifter: "VocalShifter 클립보드 데이터 붙여넣는 중...",
    status_pasting_timeline: "타임라인 클립보드 붙여넣는 중...",
    status_picking_project: "가져올 프로젝트 선택 중...",
    status_playing_original_busy: "오리지널 재생 중...",
    status_processing_audio: "오디오 처리 중...",
    status_refreshing_runtime: "런타임 새로 고치는 중...",
    ...
    clip_rate_editor_rate: "스트레치 배율",
    clip_rate_editor_old_bpm: "원본 BPM",
    clip_rate_editor_new_bpm: "새 BPM",
    clip_rate_editor_bpm_hint:
        "배율 = 새 BPM ÷ 원본 BPM. 새 BPM은 현재 배율로 미리 채워져 있으며, 수정 시 자동 계산됩니다.",
    ...
    clip_take_channel_mode: "채널 모드",
    clip_take_channel_mode_cycle: "클릭하여 전환",
    clip_channel_mode_normal: "스테레오(소스 따름)",
    clip_channel_mode_swap: "좌우 교체",
    clip_channel_mode_mono_mix: "모노(믹스)",
    clip_channel_mode_mono_left: "모노(왼쪽)",
    clip_channel_mode_mono_right: "모노(오른쪽)",
    ...
    ctx_silence_detection: "무음 감지...",
    silence_method: "감지 방식",
    silence_method_rms: "RMS(에너지)",
    silence_method_peak: "피크",
    silence_threshold: "임계값 (dBFS)",
    silence_adaptive: "적응 임계값(노이즈 플로어 + 6dB)",
    silence_adaptive_short: "자동",
    silence_min_silence: "최소 무음 (ms)",
    silence_min_sound: "최소 발성 (ms, 0 = 끄기)",
    silence_padding: "여백 (ms)",
    silence_cut_fade: "컷 페이드 (ms)",
    silence_action: "처리",
    silence_action_close: "제거 후 간격 닫기",
    silence_action_keep: "제거만(간격 유지)",
    silence_action_split: "분할만",
    silence_delete_silent_clips: "완전 무음 클립 삭제",
    silence_sync_all_takes: "모든 테이크 감지(합집합)",
    silence_analyzing: "분석 중...",
    silence_no_silence: "무음이 감지되지 않았습니다",
    silence_preview_summary: "무음 {n}구간, 총 {dur}s",
    silence_preview_clip: "{n}구간, 총 {dur}s",
    silence_skipped: "건너뜀",
    silence_more_clips: "...외 {n}개 클립",
    silence_no_audio_source: "선택한 클립에 오디오 소스가 없습니다",
    silence_apply: "적용",
    ...
    kb_playback_metronome: "메트로놈 켜기/끄기",
    metronome_volume: "음량",
    metronome_mode: "세분화",
    metronome_mode_grid: "그리드 따르기",
    ...
    kb_track_toggle_mute: "선택 트랙 음소거 / 해제",
    kb_track_toggle_solo: "선택 트랙 솔로 / 해제",
    ...
    kb_pianoroll_shift_param_up_large: "파라미터 위로 이동 (클립 범위, 큰 폭)",
    kb_pianoroll_shift_param_down_large: "파라미터 아래로 이동 (클립 범위, 큰 폭)",
    kb_pianoroll_shift_param_up_small: "파라미터 위로 이동 (클립 범위, 미세)",
    kb_pianoroll_shift_param_down_small: "파라미터 아래로 이동 (클립 범위, 미세)",
    kb_pianoroll_shift_param_up_selection: "파라미터 라인 위로 이동 (선택 범위)",
    kb_pianoroll_shift_param_down_selection: "파라미터 라인 아래로 이동 (선택 범위)",
    kb_pianoroll_shift_param_up_selection_large: "파라미터 라인 위로 이동 (선택 범위, 큰 폭)",
    kb_pianoroll_shift_param_down_selection_large: "파라미터 라인 아래로 이동 (선택 범위, 큰 폭)",
    kb_pianoroll_shift_param_up_selection_small: "파라미터 라인 위로 이동 (선택 범위, 미세)",
    kb_pianoroll_shift_param_down_selection_small: "파라미터 라인 아래로 이동 (선택 범위, 미세)",
    ...
    render_cache_summary_line: "사용량 {size} · {n}개 · 이번 세션에서 {hits}/{total}개 재사용",
    render_cache_location_label: "캐시 위치",
    render_cache_open_dir: "폴더 열기",
    render_cache_refresh: "새로 고침",
    render_cache_dir_not_writable:
        "캐시 폴더에 쓸 수 없습니다: 이번 세션은 메모리 캐시만 사용합니다.",
    ...
    render_cache_skip_tooSmall: "크기 하한 미만",
    render_cache_skip_tooLarge: "단일 상한 초과",
    render_cache_skip_lowDiskSpace: "디스크 공간 부족",
    render_cache_max_entry: "항목당 상한",
    render_cache_min_free_disk: "디스크 여유 확보",
    render_cache_write_mode: "쓰기 시점",
    render_cache_write_immediate: "렌더링 완료 즉시 쓰기(권장)",
    render_cache_write_on_exit: "앱 종료 시 일괄 쓰기",
    render_cache_write_manual: "프로젝트 저장 시에만 쓰기",
    render_cache_location_mode: "캐시 위치",
    render_cache_location_system: "앱 캐시 폴더(권장)",
    render_cache_location_custom: "사용자 지정 폴더",
    render_cache_custom_dir_placeholder: "사용자 지정 캐시 폴더의 절대 경로",
    render_cache_verify_checksum: "읽을 때 무결성 검사(손상 시 자동 재렌더링)",
    render_cache_save_settings: "설정 저장",
    render_cache_settings_saved: "설정을 저장했습니다",
    render_cache_settings_save_failed: "설정 저장 실패",
    render_cache_clear_all: "모두 지우기",
    render_cache_clear_project: "현재 프로젝트만 지우기",
    render_cache_clear_old: "만료 항목 지우기",
    render_cache_clear_other_rates: "다른 샘플레이트 지우기",
    render_cache_confirm_clear_all:
        "렌더 캐시를 모두 지우시겠습니까? 다음에 프로젝트를 열 때 다시 렌더링해야 합니다.",
    render_cache_confirm_yes: "지우기",
    render_cache_cleared: "{n}개 항목을 지우고 {size}를 확보했습니다",
    ...
    undo_history_save_with_project: "이 프로젝트 저장 시 작업 기록 저장(-UNDO 파일)",
    undo_history_save_by_default: "새 프로젝트에서 기본으로 작업 기록 저장",
    history_op_initial: "초기 상태",
    history_op_import_media: "미디어 가져오기",
    history_op_add_clip: "클립 추가",
    history_op_remove_clip: "클립 삭제",
    history_op_move_clip: "클립 이동",
    history_op_edit_clip: "클립 편집",
    history_op_replace_clip_source: "클립 소스 교체",
    history_op_split_clip: "클립 분할",
    history_op_glue_clip: "클립 접착",
    history_op_close_gaps: "간격 메우기",
    history_op_pitch_reference: "피치 참조 클립",
    history_op_duplicate_clips: "클립 복제",
    history_op_apply_linked_params: "연결 파라미터 적용",
    history_op_group_clips: "클립 그룹화",
    history_op_ungroup_clips: "그룹 해제",
    history_op_toggle_group_disabled: "그룹 활성 / 비활성",
    history_op_paste_objects: "객체 붙여넣기",
    history_op_delete_silence: "무음 구간 삭제",
    history_op_take_switch: "테이크 전환",
    history_op_take_pack: "테이크 묶기",
    history_op_take_explode: "테이크 펼치기",
    history_op_take_duplicate: "테이크 복제",
    ...
    history_op_duplicate_track: "트랙 복제",
    history_op_move_track: "트랙 이동",
    history_op_edit_track: "트랙 속성 편집",
    history_op_edit_project_length: "프로젝트 길이 변경",
    ...
    history_op_param_stretch: "파라미터 곡선 늘이기",
    history_op_param_paste: "VocalShifter 파라미터 붙여넣기",
    history_op_import_midi: "MIDI 가져오기",
    history_op_edit_midi: "MIDI 데이터 편집",
    history_op_import_vocalshifter: "VocalShifter 프로젝트 가져오기",
    history_op_recording: "녹음",
    history_op_batch: "일괄 작업",
} as const;
