export const koKR = {
    ...
    notebook_clip_missing_payload: "임시 저장된 페이로드가 없습니다(첨부 파일 삭제됨). 복원과 삽입을 사용할 수 없습니다.",
    ...
    notebook_crash_hint: "노트 내용은 그대로 남아 있습니다. Markdown 소스 보기로 전환해 확인하거나 복사하고, 패널을 닫은 뒤 다시 시도해 보세요.",
    notebook_crash_open_source: "Markdown 소스로 열기",
    notebook_image_insert_failed: "이미지를 삽입하지 못했습니다",
    notebook_image_missing_hint: "첨부 파일이 없습니다. 삭제를 실행 취소하거나 이미지를 다시 삽입하세요.",
    notebook_image_copy: "이미지 복사",
    notebook_image_save_as: "이미지를 다른 이름으로 저장...",
    notebook_image_reveal: "파일 관리자에서 표시",
    ...
    notebook_attachments_reveal: "파일 관리자에서 표시",
    ...
    notebook_setting_image_storage_sidecar: "프로젝트 옆에 복사",
    notebook_setting_image_storage_embed: "프로젝트 파일에 포함",
    notebook_setting_image_storage_link: "원본 파일 연결",
    notebook_setting_image_storage_hint: "파일을 드래그하면 원래 경로가 유지되어 연결이 동작합니다. 대화 상자에서 선택한 이미지는 항상 복사됩니다.",
    ...
    notebook_setting_export_image_mode: "이미지 내보내기 형식",
    notebook_setting_export_copy_folder: "폴더로 복사",
    notebook_setting_export_embed: "문서에 포함",
