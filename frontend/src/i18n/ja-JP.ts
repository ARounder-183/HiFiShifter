export const jaJP = {
    ...
    notebook_clip_invalid: "この一時保存ブロックは形式が不正です（id がありません）。ソースとして表示しています",
    ...
    notebook_clip_missing_payload: "一時保存されたペイロードがありません（添付ファイルが削除されました）。復元と挿入は使用できません。",
    ...
    notebook_crash_hint: "ノートの内容は失われていません。Markdown ソース表示に切り替えて確認・コピーするか、パネルを閉じて再試行してください。",
    notebook_crash_open_source: "Markdown ソースで開く",
    notebook_image_insert_failed: "画像の挿入に失敗しました",
    notebook_image_missing_hint: "添付ファイルがありません。削除を元に戻すか、画像を挿入し直してください。",
    notebook_image_copy: "画像をコピー",
    notebook_image_save_as: "画像を名前を付けて保存...",
    notebook_image_reveal: "ファイルマネージャーに表示",
    ...
    notebook_attachments_reveal: "ファイルマネージャーに表示",
    ...
    notebook_setting_image_storage_sidecar: "プロジェクトの隣にコピー",
    notebook_setting_image_storage_embed: "プロジェクトファイルに埋め込む",
    notebook_setting_image_storage_link: "元ファイルをリンク",
    notebook_setting_image_storage_hint: "ファイルをドラッグすると元のパスが保持されるためリンクが機能します。ダイアログから選択した画像は常にコピーされます。",
    ...
    notebook_setting_export_image_mode: "画像のエクスポート形式",
    notebook_setting_export_copy_folder: "フォルダにコピー",
    notebook_setting_export_embed: "ドキュメントに埋め込む",
