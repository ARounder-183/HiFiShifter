export const jaJP = {
    ...
    snap_grid_adjust_items_on_swing: "スウィング変更時に全アイテムを再整列",
    ...
    snap_section_interactions: "アイテムと特殊要素の連携",
    snap_item_start: "アイテム先頭にスナップ",
    snap_item_snap_offset: "スナップオフセットにスナップ",
    snap_across_tracks: "他トラックのアイテムへスナップ",
    ...
    snap_source_edges: "メディアアイテム端をソース先頭/末尾にスナップ",
