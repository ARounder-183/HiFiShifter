export const jaJP = {
    ...
    export_dialog_format: "出力フォーマット",
    export_dialog_encoder_params: "エンコーダ設定",
    export_dialog_mp3_mode: "エンコードモード",
    export_dialog_mp3_mode_vbr: "VBR（品質優先）",
    export_dialog_mp3_mode_cbr: "CBR（固定ビットレート）",
    export_dialog_mp3_bitrate: "ビットレート",
    export_dialog_mp3_quality: "VBR 品質",
    export_dialog_mp3_tags: "メタデータ（ID3 タグ）",
    export_dialog_tag_title: "タイトル",
    export_dialog_tag_artist: "アーティスト",
    export_dialog_tag_album: "アルバム",
    export_dialog_tag_comment: "コメント",
    export_dialog_mp3_bit_depth_note: "MP3 は内部的に 16-bit 相当の入力でエンコードします。",
    export_dialog_flac_level: "圧縮レベル",
    export_dialog_flac_level_hint: "0 = 最速、8 = 最小サイズ。",
    export_dialog_dither: "ディザ",
    export_dialog_dither_none: "オフ",
    export_dialog_dither_tpdf: "TPDF",
    export_dialog_channel_mode: "チャンネル",
    export_dialog_channel_stereo: "ステレオ",
    ...
    export_dialog_error_mp3_unsupported_sample_rate:
        "このサンプルレートは MP3 に対応していません。8kHz ～ 48kHz の MPEG 対応レートを使用してください。",
    ...
    layout_settings_hint:
        "タブをドラッグして並べ替えます。ドック修飾キーを押している間はフロートではなくドックします。",
    layout_setting_dock_modifier: "ドック修飾キー",
    layout_setting_dock_modifier_hint:
        "タブのドラッグ中に押していると、フロートではなくドックを優先します。",
    layout_modifier_primary: "Ctrl / Cmd",
    layout_modifier_alt: "Alt",
    layout_modifier_shift: "Shift",
    layout_modifier_none: "常にドック",
    layout_setting_edge_band: "端のドック感度",
    layout_setting_show_preview: "ドロップ先のプレビューを表示",
    layout_setting_tab_bar_single: "常にタブバーを表示",
    layout_setting_tab_icons: "タブにアイコンを表示",
    layout_setting_double_click: "タブをダブルクリック",
    layout_dc_float: "フロート / ドック",
    layout_dc_maximize: "最大化",
    layout_dc_collapse: "折りたたむ",
    layout_dc_none: "何もしない",
    layout_setting_float_snap: "フロートウィンドウのスナップ",
    layout_setting_snap_px: "スナップ距離",
    layout_setting_restore_floats: "起動時にフロートウィンドウを復元",
    layout_setting_startup: "起動時のレイアウト",
    layout_startup_last: "前回の配置",
    layout_setting_confirm_reset: "初期化の前に確認する",
    layout_setting_tab_position: "タブ行の位置",
    layout_tab_position_bottom: "下（既定）",
    layout_tab_position_top: "上",
    layout_setting_save_delay: "レイアウト保存の遅延",
    layout_unit_ms: "ms",
    layout_unit_px: "px",
    kb_group_layout: "レイアウト",
    kb_layout_toggle_float: "フォーカス中のパネルをフロート/ドック",
    kb_layout_next_panel: "次のパネルへフォーカス",
    kb_layout_prev_panel: "前のパネルへフォーカス",
    kb_layout_maximize: "フォーカス中のパネルを最大化/復元",
    notebook: "ノート",
    notebook_placeholder: "このプロジェクト用のメモをここに書けます...",
    notebook_mode_rich: "リッチテキスト",
    notebook_mode_source: "Markdown ソース",
    notebook_mode_split: "分割",
    ...
    notebook_project_info_value: "値",
    notebook_project_info_name: "プロジェクト",
    notebook_project_info_bpm: "BPM",
    notebook_project_info_scale: "基準スケール",
    notebook_project_info_date: "日付",
    notebook_clipboard_unavailable: "クリップボードに HiFiShifter のデータがありません",
    notebook_clipboard_staged: "クリップボードのデータをノートに一時保存しました",
    notebook_toolbar_heading1: "見出し 1",
    notebook_toolbar_heading2: "見出し 2",
    notebook_toolbar_heading3: "見出し 3",
    notebook_toolbar_paragraph: "本文",
    notebook_toolbar_bold: "太字（Ctrl+B）",
    notebook_toolbar_italic: "斜体（Ctrl+I）",
    notebook_toolbar_strike: "取り消し線",
    notebook_toolbar_inline_code: "インラインコード",
    notebook_toolbar_bullet_list: "箇条書き",
    notebook_toolbar_ordered_list: "番号付きリスト",
    notebook_toolbar_task_list: "タスクリスト",
    notebook_toolbar_quote: "引用",
    notebook_toolbar_code_block: "コードブロック",
    notebook_toolbar_link: "リンク（Ctrl+K）",
    notebook_toolbar_image: "画像を挿入",
    notebook_toolbar_table: "表を挿入",
    notebook_toolbar_rule: "水平線",
    notebook_toolbar_timecode: "再生ヘッドの時間を挿入",
    notebook_toolbar_clip_ref: "クリップ参照を挿入",
    notebook_toolbar_stage_clipboard: "クリップボードのデータを一時保存",
    notebook_toolbar_project_info: "プロジェクト情報を挿入",
    notebook_link_prompt: "リンク先アドレス",
    notebook_clip_invalid:
        "この一時保存ブロックは形式が不正です（id がありません）。ソースとして表示しています",
    notebook_clip_actions: "操作",
    notebook_clip_kind_clips: "クリップ",
    notebook_clip_kind_tracks: "トラック",
    notebook_clip_kind_project: "プロジェクト",
    notebook_clip_kind_param: "パラメータ",
    notebook_clip_restore: "クリップボードに復元",
    notebook_clip_insert_timeline: "タイムラインに挿入",
    notebook_clip_insert_new_tracks: "新しいトラックとして挿入",
    notebook_clip_rename: "名前を変更",
    notebook_clip_copy_markdown: "Markdown としてコピー",
    ...
    notebook_clip_missing_payload:
        "一時保存されたペイロードがありません（添付ファイルが削除されました）。復元と挿入は使用できません。",
    notebook_clip_restored: "システムクリップボードに復元しました",
    notebook_clip_inserted: "タイムラインに送信しました",
    notebook_clip_action_failed: "操作に失敗しました",
    notebook_clip_from: "取得元",
    notebook_clip_unit_clips: "クリップ",
    notebook_clip_unit_tracks: "トラック",
    notebook_clip_unit_frames: "フレーム",
    notebook_image_missing: "画像が見つかりません",
    notebook_image_loading: "画像を読み込み中...",
    notebook_crash_title: "ノートの読み込みに失敗しました",
    notebook_crash_hint:
    ...
    notebook_image_save_as: "画像を名前を付けて保存...",
    ...
    notebook_find_prev: "前を検索",
    notebook_find_next: "次を検索",
    notebook_status_characters: "文字",
    notebook_status_images: "画像",
    notebook_status_clips: "一時保存",
    notebook_status_unsaved: "未保存",
    notebook_status_saved: "保存済み",
    notebook_attachments_empty: "このプロジェクトにはまだ添付ファイルがありません。",
    notebook_attachments_clean: "未使用を削除",
    notebook_attachments_clean_hint: "ノートから参照されなくなった添付ファイルを削除します",
    notebook_attachments_cleaned: "クリーンアップしました",
    notebook_attachments_used: "使用中",
    notebook_attachments_unused: "未使用",
    notebook_attachments_save_as: "名前を付けて保存...",
    notebook_attachments_removed: "添付ファイルを削除しました",
    notebook_settings_group_view: "表示と編集",
    notebook_settings_group_image: "画像",
    notebook_settings_group_clipboard: "クリップボード",
    notebook_settings_group_clip_block: "クリップボードの一時保存ブロック",
    notebook_settings_group_export: "エクスポート",
    notebook_setting_default_mode: "既定の表示",
    notebook_setting_toolbar: "書式ツールバーを表示",
    notebook_setting_markdown_shortcuts: "Markdown 入力ショートカット",
    ...
    notebook_setting_remote_images: "外部画像を読み込む",
    notebook_setting_smart_paste: "スマートペースト",
    notebook_setting_html_paste: "リッチテキストの貼り付け形式",
    notebook_setting_plain_paste: "プレーンテキストの貼り付け形式",
    notebook_setting_plain_paste_auto: "Markdown を自動判別",
    notebook_setting_paste_text: "プレーンテキスト",
    notebook_setting_copy_format: "コピー形式",
    notebook_setting_copy_format_both: "Markdown + HTML",
    notebook_setting_copy_plain: "プレーンテキスト形式",
    notebook_setting_copy_plain_markdown: "Markdown ソース",
    notebook_setting_clip_insert_mode: "一時保存クリップの挿入先",
    ...
    notebook_setting_keep_clip: "挿入後も一時保存ブロックを残す",
    notebook_setting_clip_preview: "一時保存ブロック内にプレビューを表示",
    notebook_export_md: "Markdown としてエクスポート",
    notebook_export_running: "エクスポート中...",
    notebook_export_done: "エクスポートしました",
    notebook_export_failed: "エクスポートに失敗しました",
    notebook_export_missing: "添付ファイルが見つかりません",
    notebook_export_html: "HTML としてエクスポート",
    ...
    status_audio_stopped: "オーディオを停止しました",
    status_stop_audio_failed: "オーディオの停止に失敗しました",
    status_audio_imported: "オーディオをインポートしました",
    status_dropped_audio_imported: "ドロップしたオーディオをインポートしました",
    status_clips_duplicated: "クリップを複製しました",
    status_clip_edit_rejected: "クリップ編集が拒否されました",
    status_import_done: "インポート完了",
    status_import_failed: "インポートに失敗しました",
    status_project_imported: "プロジェクトをインポートしました",
    status_vocalshifter_project_imported: "VocalShifter プロジェクトをインポートしました",
    status_reaper_project_imported: "REAPER プロジェクトをインポートしました",
    status_pasted_vocalshifter_clipboard: "VocalShifter クリップボードデータをペーストしました",
    status_pasted_reaper_clipboard: "REAPER クリップボードデータをペーストしました",
    status_timeline_clipboard_pasted: "タイムラインクリップボードをペーストしました",
    status_paste_timeline_failed: "タイムラインクリップボードのペーストに失敗しました",
    status_tempo_map_updated: "テンポマップを更新しました",
    status_waiting_import_options: "インポートオプションを待っています...",
    status_waveform_cache_cleared: "波形キャッシュをクリアしました（{n} 件）",
    status_take_switch_rejected: "テイクの切り替えが拒否されました",
    status_take_cycle_rejected: "テイクの巡回切り替えが拒否されました",
    status_take_reverse_rejected: "テイクの逆再生が拒否されました",
    status_add_take_failed: "メディアからテイクを追加できませんでした",
    status_duplicate_take_failed: "テイクを複製できませんでした",
    status_explode_takes_failed: "テイクを分割できませんでした",
    status_pack_takes_failed: "テイクに集約できませんでした",
    status_remove_take_failed: "テイクを削除できませんでした",
    status_rename_take_failed: "テイクの名前変更に失敗しました",
    status_applying_pitch_shift: "ピッチシフトを適用中...",
    status_clearing_waveform_cache: "波形キャッシュをクリア中...",
    status_exporting_wav: "WAV をエクスポート中...",
    status_exporting_audio: "オーディオをエクスポート中...",
    status_exporting_separated: "トラック別にエクスポート中...",
    status_importing_midi: "MIDI クリップをインポート中...",
    status_importing_reaper: "REAPER プロジェクトをインポート中...",
    status_importing_vocalshifter: "VocalShifter プロジェクトをインポート中...",
    status_importing_audio: "オーディオをインポート中...",
    status_importing_dropped: "ドロップしたオーディオをインポート中...",
    status_importing_multiple: "複数のオーディオファイルをインポート中...",
    status_importing_project: "プロジェクトをインポート中...",
    status_loading_default_model: "デフォルトモデルを読み込み中...",
    status_loading_model: "モデルを読み込み中...",
    status_pasting_reaper: "REAPER クリップボードデータをペースト中...",
    status_pasting_vocalshifter: "VocalShifter クリップボードデータをペースト中...",
    status_pasting_timeline: "タイムラインクリップボードをペースト中...",
    status_picking_project: "インポートするプロジェクトを選択中...",
    status_playing_original_busy: "オリジナルを再生中...",
    status_processing_audio: "オーディオを処理中...",
    status_refreshing_runtime: "ランタイムを更新中...",
    ...
    clip_take_channel_mode: "チャンネルモード",
    clip_take_channel_mode_cycle: "クリックで切り替え",
    clip_channel_mode_normal: "ステレオ（ソース準拠）",
    clip_channel_mode_swap: "左右を入れ替え",
    clip_channel_mode_mono_mix: "モノラル（混合）",
    clip_channel_mode_mono_left: "モノラル（左）",
    clip_channel_mode_mono_right: "モノラル（右）",
    ...
    ctx_silence_detection: "無音検出...",
    silence_method: "検出方式",
    silence_method_rms: "RMS（エネルギー）",
    silence_method_peak: "ピーク",
    silence_threshold: "しきい値 (dBFS)",
    silence_adaptive: "適応しきい値（ノイズフロア + 6 dB）",
    silence_adaptive_short: "自動",
    silence_min_silence: "最短無音 (ms)",
    silence_min_sound: "最短発声 (ms、0 = オフ)",
    silence_padding: "余白 (ms)",
    silence_cut_fade: "カットフェード (ms)",
    silence_action: "処理",
    silence_action_close: "削除して隙間を閉じる",
    silence_action_keep: "削除のみ（隙間を残す）",
    silence_action_split: "分割のみ",
    silence_delete_silent_clips: "完全無音のクリップを削除",
    silence_sync_all_takes: "全テイクを検出（和集合）",
    silence_analyzing: "解析中...",
    silence_no_silence: "無音は検出されませんでした",
    silence_preview_summary: "{n} 箇所の無音、計 {dur}s",
    silence_preview_clip: "{n} 箇所、計 {dur}s",
    silence_skipped: "スキップ",
    silence_more_clips: "...他 {n} クリップ",
    silence_no_audio_source: "選択したクリップに音声ソースがありません",
    silence_apply: "適用",
    ...
    kb_playback_metronome: "メトロノーム切り替え",
    metronome_volume: "音量",
    metronome_mode: "分割",
    metronome_mode_grid: "グリッドに追従",
    metronome_mode_beat: "拍のみ",
    metronome_mode_bar: "小節頭のみ",
    metronome_sound: "音色",
    metronome_sound_click: "クリック",
    metronome_sound_woodblock: "ウッドブロック",
    metronome_sound_beep: "ビープ",
    metronome_accent: "強拍をアクセントに",
    ...
    kb_track_toggle_mute: "選択トラックをミュート / 解除",
    kb_track_toggle_solo: "選択トラックをソロ / 解除",
    ...
    kb_pianoroll_shift_param_up_large: "パラメータを上へ移動（クリップ範囲・大）",
    kb_pianoroll_shift_param_down_large: "パラメータを下へ移動（クリップ範囲・大）",
    kb_pianoroll_shift_param_up_small: "パラメータを上へ移動（クリップ範囲・微細）",
    kb_pianoroll_shift_param_down_small: "パラメータを下へ移動（クリップ範囲・微細）",
    kb_pianoroll_shift_param_up_selection: "パラメーターライン上移動（選択範囲）",
    kb_pianoroll_shift_param_down_selection: "パラメーターライン下移動（選択範囲）",
    kb_pianoroll_shift_param_up_selection_large: "パラメーターライン上移動（選択範囲・大）",
    kb_pianoroll_shift_param_down_selection_large: "パラメーターライン下移動（選択範囲・大）",
    kb_pianoroll_shift_param_up_selection_small: "パラメーターライン上移動（選択範囲・微細）",
    kb_pianoroll_shift_param_down_selection_small: "パラメーターライン下移動（選択範囲・微細）",
    ...
    render_cache_summary_line:
        "使用量 {size} · {n} 件 · 今回のセッションで {hits}/{total} 件を再利用",
    render_cache_location_label: "キャッシュの場所",
    render_cache_open_dir: "フォルダーを開く",
    render_cache_refresh: "更新",
    render_cache_dir_not_writable:
        "キャッシュフォルダーに書き込めません：今回はメモリキャッシュのみ使用します。",
    ...
    render_cache_skip_tooSmall: "サイズの下限未満",
    render_cache_skip_tooLarge: "単体上限超過",
    render_cache_skip_lowDiskSpace: "ディスク空き不足",
    render_cache_max_entry: "1 件の上限",
    render_cache_min_free_disk: "ディスクの空き確保",
    render_cache_write_mode: "書き込みのタイミング",
    render_cache_write_immediate: "レンダリング完了時に書き込み（推奨）",
    render_cache_write_on_exit: "アプリ終了時にまとめて書き込み",
    render_cache_write_manual: "プロジェクト保存時のみ書き込み",
    render_cache_location_mode: "キャッシュの場所",
    render_cache_location_system: "アプリのキャッシュフォルダー（推奨）",
    render_cache_location_custom: "カスタムフォルダー",
    render_cache_custom_dir_placeholder: "カスタムキャッシュフォルダーの絶対パス",
    render_cache_verify_checksum: "読み込み時に整合性を検証（破損時は自動で再レンダリング）",
    render_cache_save_settings: "設定を保存",
    render_cache_settings_saved: "設定を保存しました",
    render_cache_settings_save_failed: "設定の保存に失敗しました",
    render_cache_clear_all: "すべて削除",
    render_cache_clear_project: "現在のプロジェクトのみ削除",
    render_cache_clear_old: "期限切れを削除",
    render_cache_clear_other_rates: "他のサンプルレートを削除",
    render_cache_confirm_clear_all:
        "レンダーキャッシュをすべて削除しますか？次回プロジェクトを開く際に再レンダリングが必要になります。",
    render_cache_confirm_yes: "削除する",
    render_cache_cleared: "{n} 件を削除し、{size} を解放しました",
    ...
    undo_history_save_with_project: "このプロジェクトの保存時に操作記録を保存（-UNDO ファイル）",
    undo_history_save_by_default: "新規プロジェクトでは既定で操作記録を保存",
    history_op_initial: "初期状態",
    history_op_import_media: "メディアをインポート",
    history_op_add_clip: "クリップを追加",
    history_op_remove_clip: "クリップを削除",
    history_op_move_clip: "クリップを移動",
    history_op_edit_clip: "クリップを編集",
    history_op_replace_clip_source: "クリップ素材を差し替え",
    history_op_split_clip: "クリップを分割",
    history_op_glue_clip: "クリップを連結",
    history_op_close_gaps: "隙間を詰める",
    history_op_pitch_reference: "ピッチ参照クリップ",
    history_op_duplicate_clips: "クリップを複製",
    history_op_apply_linked_params: "リンクパラメータを適用",
    history_op_group_clips: "クリップをグループ化",
    history_op_ungroup_clips: "グループを解除",
    history_op_toggle_group_disabled: "グループの有効 / 無効",
    history_op_paste_objects: "オブジェクトを貼り付け",
    history_op_delete_silence: "無音区間を削除",
    history_op_take_switch: "テイクを切り替え",
    history_op_take_pack: "テイクをまとめる",
    history_op_take_explode: "テイクを展開",
    history_op_take_duplicate: "テイクを複製",
    ...
    history_op_duplicate_track: "トラックを複製",
    history_op_move_track: "トラックを移動",
    history_op_edit_track: "トラック設定を変更",
    history_op_edit_project_length: "プロジェクト長を変更",
    ...
    history_op_param_stretch: "パラメータカーブを伸縮",
    history_op_param_paste: "VocalShifter パラメータを貼り付け",
    history_op_import_midi: "MIDI をインポート",
    history_op_edit_midi: "MIDI データを編集",
    history_op_import_vocalshifter: "VocalShifter プロジェクトをインポート",
    history_op_recording: "録音",
    history_op_batch: "一括操作",
} as const;
