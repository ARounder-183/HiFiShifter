export const jaJP = {
    ...
    // VST プラグインホスト
    vst_fx: "FX",
    vst_chain_editor_title: "VST エフェクトチェーン",
    vst_scan_plugins: "プラグインをスキャン",
    vst_scanning: "スキャン中...",
    vst_add_plugin: "プラグインを追加",
    vst_remove_plugin: "削除",
    vst_bypass: "バイパス",
    vst_open_editor: "エディタを開く",
    vst_no_plugins: "プラグインが見つかりません。スキャンをクリックして検索してください。",
    vst_empty_chain: "エフェクトチェーンが空です。+ をクリックして追加してください。",
    vst_plugin_browser_title: "VST プラグインブラウザ",
    vst_format: "フォーマット",
    vst_vendor: "ベンダー",
    vst_category: "カテゴリ",
    vst_path: "パス",
    vst_not_available: "VST ホストが利用できません",
    vst_add_scan_path: "スキャンパスを追加",
    ...
    vst_manage_scan_paths: "スキャンパスを管理",
} as const;
