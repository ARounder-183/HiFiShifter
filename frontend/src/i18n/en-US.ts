export const enUS = {
    ...
    notebook_image_too_large: "The image is too large and exceeds the size limit",
    notebook_image_undecodable: "Could not decode the image",
    notebook_image_read_failed: "Failed to read the image file",
    notebook_image_save_failed: "Failed to save the image",
    notebook_paste_nothing: "Nothing pasteable in the clipboard",
    notebook_error_bad_base64: "The attachment data is not valid base64",
    notebook_error_not_a_file: "The path does not point to a regular file",
    notebook_error_unsupported_image_ext: "Unsupported image type",
    notebook_error_export_mkdir_failed: "Failed to create the export folder",
    ...
    clip_channel_import_mode_hint:
        "Smart conversion samples both channels and folds only the material it judges identical.",
    clip_channel_import_mode_off_hint:
        "Every clip keeps the channel count it was imported with; no automatic judgement is made.",
    ...
    render_cache_skip_tooSmall: "below size floor",
    render_cache_skip_tooLarge: "above per-entry cap",
    render_cache_skip_lowDiskSpace: "low disk space",
