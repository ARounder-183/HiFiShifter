export const enUS = {
    ...
    snap_grid_adjust_items_on_swing: "Adjust all items when changing swing",
    ...
    snap_item_snap_offset: "Snap item snap offset",
    snap_across_tracks: "Snap media items across tracks",
    ...
    snap_source_edges: "Snap media item edges to source media start/end",
