export const enUS = {
    ...
    history_op_remove_clip: "Delete clip",
    history_op_move_clip: "Move clip",
    history_op_edit_clip: "Edit clip",
    history_op_replace_clip_source: "Replace clip source",
    history_op_split_clip: "Split clip",
    history_op_glue_clip: "Glue clips",
    history_op_close_gaps: "Close gaps",
    history_op_pitch_reference: "Pitch reference clip",
    history_op_duplicate_clips: "Duplicate clips",
    history_op_apply_linked_params: "Apply linked params",
    history_op_group_clips: "Group clips",
    history_op_ungroup_clips: "Ungroup clips",
    history_op_toggle_group_disabled: "Toggle group enabled",
    history_op_paste_objects: "Paste objects",
    history_op_delete_silence: "Delete silence",
    history_op_take_switch: "Switch take",
    history_op_take_pack: "Pack takes",
    history_op_take_explode: "Explode takes",
    history_op_take_duplicate: "Duplicate take",
    ...
    history_op_duplicate_track: "Duplicate track",
    history_op_move_track: "Move track",
    history_op_edit_track: "Edit track",
    history_op_edit_project_length: "Change project length",
    ...
    history_op_param_stretch: "Stretch parameter curve",
    history_op_param_paste: "Paste VocalShifter params",
    history_op_import_midi: "Import MIDI",
    history_op_edit_midi: "Edit MIDI data",
    history_op_import_vocalshifter: "Import VocalShifter project",
    history_op_recording: "Recording",
    history_op_batch: "Batch operation",
    ...
    export_dialog_format: "Output Format",
    export_dialog_encoder_params: "Encoder Settings",
    export_dialog_mp3_mode: "Encoding Mode",
    export_dialog_mp3_mode_vbr: "VBR (quality-first)",
    export_dialog_mp3_mode_cbr: "CBR (constant bitrate)",
    export_dialog_mp3_bitrate: "Bitrate",
    export_dialog_mp3_quality: "VBR Quality",
    export_dialog_mp3_tags: "Metadata (ID3 Tags)",
    export_dialog_tag_title: "Title",
    export_dialog_tag_artist: "Artist",
    export_dialog_tag_album: "Album",
    export_dialog_tag_comment: "Comment",
    export_dialog_mp3_bit_depth_note: "MP3 encodes from 16-bit-equivalent input internally.",
    export_dialog_flac_level: "Compression Level",
    export_dialog_flac_level_hint: "0 = fastest, 8 = smallest file.",
    export_dialog_dither: "Dither",
    export_dialog_dither_none: "Off",
    export_dialog_dither_tpdf: "TPDF",
    export_dialog_channel_mode: "Channels",
    export_dialog_channel_stereo: "Stereo",
    export_dialog_channel_mono: "Mono (mixdown)",
    export_dialog_sample_rate_autocorrected:
        "Sample rate adjusted to the nearest MP3-supported value: {rate} Hz.",
    export_dialog_error_mp3_unsupported_sample_rate:
        "The sample rate is not supported by MP3. Use one of the MPEG rates between 8 kHz and 48 kHz.",
    quick_export_format: "Format",
    ...
    clip_formant_no_voiced: "No stable vowel detected; formant shifting may not be audible",
    language: "Language",
    lang_en: "English",
    lang_zh: "简体中文",
    lang_zh_tw: "繁體中文",
    ...
    dock_side_right: "right edge",
    dock_side_top: "top edge",
    ...
    layout_settings_hint:
        "Rearrange panels by dragging their tabs; hold the dock modifier to dock instead of floating.",
    layout_setting_dock_modifier: "Dock modifier",
    layout_setting_dock_modifier_hint:
        "Hold it while dragging a tab to dock the panel instead of floating it.",
    layout_modifier_primary: "Ctrl / Cmd",
    layout_modifier_alt: "Alt",
    layout_modifier_shift: "Shift",
    layout_modifier_none: "Always dock",
    layout_setting_edge_band: "Edge dock sensitivity",
    layout_setting_show_preview: "Show the drop preview",
    layout_setting_tab_bar_single: "Always show the tab bar",
    layout_setting_tab_icons: "Show icons on tabs",
    layout_setting_double_click: "Double-clicking a tab",
    layout_dc_float: "Float / dock",
    layout_dc_maximize: "Maximize",
    layout_dc_collapse: "Collapse",
    layout_dc_none: "Do nothing",
    layout_setting_float_snap: "Snap floating windows",
    layout_setting_snap_px: "Snap distance",
    layout_setting_restore_floats: "Restore floating windows on startup",
    layout_setting_startup: "Layout on startup",
    layout_startup_last: "Last used",
    layout_setting_confirm_reset: "Ask before resetting the layout",
    layout_setting_tab_position: "Tab row position",
    layout_tab_position_bottom: "Bottom (default)",
    layout_tab_position_top: "Top",
    layout_setting_save_delay: "Layout save delay",
    layout_unit_ms: "ms",
    layout_unit_px: "px",
    kb_group_layout: "Layout",
    kb_layout_toggle_float: "Float / dock the focused panel",
    kb_layout_next_panel: "Focus the next panel",
    kb_layout_prev_panel: "Focus the previous panel",
    kb_layout_maximize: "Maximize / restore the focused panel",
    notebook: "Notebook",
    notebook_placeholder: "Write project notes here...",
    notebook_mode_rich: "Rich text",
    notebook_mode_source: "Markdown source",
    notebook_mode_split: "Split",
    ...
    notebook_project_info_value: "Value",
    notebook_project_info_name: "Project",
    notebook_project_info_bpm: "BPM",
    notebook_project_info_scale: "Base scale",
    notebook_project_info_date: "Date",
    notebook_clipboard_unavailable: "The clipboard has no HiFiShifter data",
    notebook_clipboard_staged: "Clipboard data staged in the notebook",
    notebook_toolbar_heading1: "Heading 1",
    notebook_toolbar_heading2: "Heading 2",
    notebook_toolbar_heading3: "Heading 3",
    notebook_toolbar_paragraph: "Body text",
    notebook_toolbar_bold: "Bold (Ctrl+B)",
    notebook_toolbar_italic: "Italic (Ctrl+I)",
    notebook_toolbar_strike: "Strikethrough",
    notebook_toolbar_inline_code: "Inline code",
    notebook_toolbar_bullet_list: "Bullet list",
    notebook_toolbar_ordered_list: "Numbered list",
    notebook_toolbar_task_list: "Task list",
    notebook_toolbar_quote: "Quote",
    notebook_toolbar_code_block: "Code block",
    notebook_toolbar_link: "Link (Ctrl+K)",
    notebook_toolbar_image: "Insert image",
    notebook_toolbar_table: "Insert table",
    notebook_toolbar_rule: "Horizontal rule",
    notebook_toolbar_timecode: "Insert playhead time",
    notebook_toolbar_clip_ref: "Insert clip reference",
    notebook_toolbar_stage_clipboard: "Stage clipboard data",
    notebook_toolbar_project_info: "Insert project info",
    notebook_link_prompt: "Link address",
    notebook_clip_invalid: "This staged block is malformed (missing id) and is shown as source",
    notebook_clip_actions: "Actions",
    notebook_clip_kind_clips: "Clips",
    notebook_clip_kind_tracks: "Tracks",
    notebook_clip_kind_project: "Project",
    notebook_clip_kind_param: "Parameter",
    notebook_clip_restore: "Restore to clipboard",
    notebook_clip_insert_timeline: "Insert into timeline",
    notebook_clip_insert_new_tracks: "Insert as new tracks",
    notebook_clip_rename: "Rename",
    notebook_clip_copy_markdown: "Copy as Markdown",
    ...
    notebook_clip_missing_payload:
        "The staged payload is missing (attachment deleted). Restore and insert are unavailable.",
    notebook_clip_restored: "Restored to the system clipboard",
    notebook_clip_inserted: "Sent to the timeline",
    notebook_clip_action_failed: "Action failed",
    notebook_clip_from: "from",
    notebook_clip_unit_clips: "clip(s)",
    notebook_clip_unit_tracks: "track(s)",
    notebook_clip_unit_frames: "frame(s)",
    notebook_image_missing: "Image not found",
    notebook_image_loading: "Loading image...",
    notebook_crash_title: "The notebook failed to load",
    notebook_crash_hint:
        "Your notes are safe. Open the Markdown source view to read or copy them, or close the panel and try again.",
    notebook_crash_open_source: "Open Markdown source",
    notebook_image_insert_failed: "Failed to insert the image",
    notebook_image_missing_hint:
        "The attachment file is missing. Undo the deletion, or insert the image again.",
    notebook_image_copy: "Copy image",
    notebook_image_save_as: "Save image as...",
    ...
    notebook_find_prev: "Previous match",
    notebook_find_next: "Next match",
    notebook_status_characters: "chars",
    notebook_status_images: "images",
    notebook_status_clips: "staged",
    notebook_status_unsaved: "Unsaved",
    notebook_status_saved: "Saved",
    notebook_attachments_empty: "No attachments in this project yet.",
    notebook_attachments_clean: "Remove unused",
    notebook_attachments_clean_hint: "Delete attachments that the notebook no longer references",
    notebook_attachments_cleaned: "Cleaned up",
    notebook_attachments_used: "in use",
    notebook_attachments_unused: "unused",
    notebook_attachments_save_as: "Save as...",
    notebook_attachments_removed: "Attachment removed",
    notebook_settings_group_view: "View and editing",
    notebook_settings_group_image: "Images",
    notebook_settings_group_clipboard: "Clipboard",
    notebook_settings_group_clip_block: "Staged clipboard blocks",
    notebook_settings_group_export: "Export",
    notebook_setting_default_mode: "Default view",
    notebook_setting_toolbar: "Show formatting toolbar",
    notebook_setting_markdown_shortcuts: "Markdown input shortcuts",
    ...
    notebook_setting_image_max_dim: "Max image dimension",
    notebook_setting_image_max_dim_original: "Original",
    notebook_setting_image_format: "Image format",
    notebook_setting_image_format_auto: "Automatic",
    notebook_setting_remote_images: "Load remote images",
    notebook_setting_smart_paste: "Smart paste",
    notebook_setting_html_paste: "Paste rich text as",
    notebook_setting_plain_paste: "Paste plain text as",
    notebook_setting_plain_paste_auto: "Detect Markdown",
    notebook_setting_paste_text: "Plain text",
    notebook_setting_copy_format: "Copy as",
    notebook_setting_copy_format_both: "Markdown + HTML",
    notebook_setting_copy_plain: "Plain-text flavour",
    notebook_setting_copy_plain_markdown: "Markdown source",
    notebook_setting_clip_insert_mode: "Insert staged clips into",
    ...
    notebook_setting_keep_clip: "Keep staged block after insert",
    notebook_setting_clip_preview: "Show preview inside staged blocks",
    notebook_export_md: "Export as Markdown",
    notebook_export_running: "Exporting...",
    notebook_export_done: "Exported",
    notebook_export_failed: "Export failed",
    notebook_export_missing: "missing attachments",
    notebook_export_html: "Export as HTML",
    ...
    status_playing_original: "Playing original",
    status_play_original_failed: "Play original failed",
    status_stopping_audio: "Stopping audio...",
    status_audio_stopped: "Audio stopped",
    status_stop_audio_failed: "Stop audio failed",
    status_audio_imported: "Audio imported",
    status_dropped_audio_imported: "Dropped audio imported",
    status_clips_duplicated: "Clips duplicated",
    status_clip_edit_rejected: "Clip edit rejected",
    status_import_done: "Import done",
    status_import_failed: "Import failed",
    status_project_imported: "Project imported",
    status_vocalshifter_project_imported: "VocalShifter project imported",
    status_reaper_project_imported: "REAPER project imported",
    status_pasted_vocalshifter_clipboard: "Pasted VocalShifter clipboard data",
    status_pasted_reaper_clipboard: "Pasted REAPER clipboard data",
    status_timeline_clipboard_pasted: "Timeline clipboard pasted",
    status_paste_timeline_failed: "Paste timeline clipboard failed",
    status_tempo_map_updated: "Tempo map updated",
    status_waiting_import_options: "Waiting for import options",
    status_waveform_cache_cleared: "Waveform cache cleared ({n} files)",
    status_take_switch_rejected: "Take switch rejected",
    status_take_cycle_rejected: "Take cycle rejected",
    status_take_reverse_rejected: "Take reverse rejected",
    status_add_take_failed: "Add take from media failed",
    status_duplicate_take_failed: "Duplicate take failed",
    status_explode_takes_failed: "Explode takes failed",
    status_pack_takes_failed: "Pack into takes failed",
    status_remove_take_failed: "Remove take failed",
    status_rename_take_failed: "Rename take failed",
    status_applying_pitch_shift: "Applying pitch shift...",
    status_clearing_waveform_cache: "Clearing waveform cache...",
    status_exporting_wav: "Exporting WAV...",
    status_exporting_audio: "Exporting audio...",
    status_exporting_separated: "Exporting separated tracks...",
    status_importing_midi: "Importing MIDI clip...",
    status_importing_reaper: "Importing REAPER project...",
    status_importing_vocalshifter: "Importing VocalShifter project...",
    status_importing_audio: "Importing audio...",
    status_importing_dropped: "Importing dropped audio...",
    status_importing_multiple: "Importing multiple audio files...",
    status_importing_project: "Importing project...",
    status_loading_default_model: "Loading default model...",
    status_loading_model: "Loading model...",
    status_pasting_reaper: "Pasting REAPER clipboard data...",
    status_pasting_vocalshifter: "Pasting VocalShifter clipboard data...",
    status_pasting_timeline: "Pasting timeline clipboard...",
    status_picking_project: "Picking project to import...",
    status_playing_original_busy: "Playing original...",
    status_processing_audio: "Processing audio...",
    status_refreshing_runtime: "Refreshing runtime...",
    ...
    clip_rate_editor_rate: "Stretch factor",
    clip_rate_editor_old_bpm: "Original BPM",
    clip_rate_editor_new_bpm: "New BPM",
    clip_rate_editor_bpm_hint:
        "Rate = New BPM / Original BPM. New BPM is prefilled from the current rate; edit any field to recalculate.",
    ...
    clip_take_cycle_next: "Switch to Next Take",
    clip_take_cycle_prev: "Switch to Previous Take",
    clip_take_duplicate: "Duplicate Current Take",
    clip_take_reverse: "Reverse",
    clip_take_channel_mode: "Channel mode",
    clip_take_channel_mode_cycle: "Click to cycle",
    clip_channel_mode_normal: "Stereo (per source)",
    clip_channel_mode_swap: "Swap L/R",
    clip_channel_mode_mono_mix: "Mono (mix)",
    clip_channel_mode_mono_left: "Mono (left)",
    clip_channel_mode_mono_right: "Mono (right)",
    clip_channel_source_stereo: "Stereo source",
    clip_channel_source_mono: "Mono source",
    ctx_channel_mode: "Channel Mode",
    clip_bulk_apply_all_takes: "Apply to all takes",
    clip_bulk_apply_all_takes_hint: "When off, only the active take changes. Defaults to the 'sync edits across takes' setting.",
    ctx_scan_fake_stereo: "Scan for Fake Stereo and Convert",
    ctx_scan_fake_stereo_dry_run: "Scan Only (no changes)",
    ctx_scan_fake_stereo_hint: "Material whose left and right channels match can be folded to mono: identical sound, half the render time. A batch run becomes a single undo step.",
    clip_channel_import_dialog_title: "Import Channel Handling",
    clip_channel_import_dialog_desc: "On import, the left and right channels are compared: 'fake stereo' (identical content) is folded to mono, halving render time. Applies only to material with no channel information (media import, VocalShifter import, old project upgrades). REAPER import/export carries its own channel settings and is unaffected.",
    ...
    clip_channel_import_mode_off: "Never convert channels",
    clip_channel_import_mode_hint: "Smart conversion samples both channels and folds only the material it judges identical.",
    clip_channel_import_mode_off_hint: "Every clip keeps the channel count it was imported with; no automatic judgement is made.",
    clip_channel_import_target_mode: "Convert to",
    clip_channel_import_advanced: "Detection parameters (advanced)",
    clip_channel_import_window_sec: "Sample window length (s)",
    clip_channel_import_window_count: "Sample window count",
    clip_channel_import_window_hint: "Windows spread evenly across the material's consumed range, always covering both ends. 0 scans the whole range without sampling.",
    clip_channel_import_tolerance: "Tolerance",
    clip_channel_import_tolerance_exact: "Sample-exact",
    clip_channel_import_tolerance_hint: "Lossy codecs (MP3/AAC) can decode left and right with tiny differences. Too strict misses folds; too loose folds by mistake.",
    clip_channel_import_apply_legacy: "Also apply to old projects",
    clip_channel_import_apply_legacy_hint: "When opening a v4-or-earlier project, takes with no recorded channel setting follow the policy above. In v5+ projects the setting is your explicit choice and is never rewritten.",
    ...
    ctx_silence_detection: "Silence Detection...",
    silence_method: "Detection",
    silence_method_rms: "RMS (energy)",
    silence_method_peak: "Peak",
    silence_threshold: "Threshold (dBFS)",
    silence_adaptive: "Adaptive threshold (noise floor + 6 dB)",
    silence_adaptive_short: "Auto",
    silence_min_silence: "Min silence (ms)",
    silence_min_sound: "Min sound (ms, 0 = off)",
    silence_padding: "Padding (ms)",
    silence_cut_fade: "Cut fade (ms)",
    silence_action: "Action",
    silence_action_close: "Remove & close gaps",
    silence_action_keep: "Remove only (keep gaps)",
    silence_action_split: "Split only",
    silence_delete_silent_clips: "Delete fully silent clips",
    silence_sync_all_takes: "Detect across all takes (union)",
    silence_analyzing: "Analyzing...",
    silence_no_silence: "No silence detected",
    silence_preview_summary: "{n} silent regions, {dur}s total",
    silence_preview_clip: "{n} regions, {dur}s",
    silence_skipped: "Skipped",
    silence_more_clips: "...and {n} more clips",
    silence_no_audio_source: "No audio source in the selected clips",
    silence_apply: "Apply",
    ...
    kb_playback_metronome: "Toggle Metronome",
    metronome_volume: "Volume",
    metronome_mode: "Subdivision",
    metronome_mode_grid: "Follow Grid",
    metronome_mode_beat: "Beats Only",
    metronome_mode_bar: "Downbeats Only",
    metronome_sound: "Sound",
    metronome_sound_click: "Click",
    metronome_sound_woodblock: "Woodblock",
    metronome_sound_beep: "Beep",
    metronome_accent: "Accent Downbeats",
    ...
    kb_project_import_media: "Import Media File",
    kb_project_import_midi: "Import MIDI",
    kb_project_import_hifishifter: "Import HiFiShifter Project",
    kb_project_import_reaper: "Import Reaper Project",
    kb_project_import_vocalshifter: "Import VocalShifter Project",
    kb_track_add: "Add Track",
    kb_track_clone: "Clone Selected Track",
    kb_track_delete: "Delete Selected Track",
    kb_track_select_up: "Select Previous Track",
    kb_track_select_down: "Select Next Track",
    kb_track_toggle_mute: "Mute / Unmute Selected Track",
    kb_track_toggle_solo: "Solo / Unsolo Selected Track",
    ...
    kb_pianoroll_shift_param_up_large: "Shift Param Up (clip range, large step)",
    kb_pianoroll_shift_param_down_large: "Shift Param Down (clip range, large step)",
    kb_pianoroll_shift_param_up_small: "Shift Param Up (clip range, fine step)",
    kb_pianoroll_shift_param_down_small: "Shift Param Down (clip range, fine step)",
    ...
    kb_pianoroll_shift_param_up_selection_large: "Shift Param Up (selection range, large step)",
    kb_pianoroll_shift_param_down_selection_large: "Shift Param Down (selection range, large step)",
    kb_pianoroll_shift_param_up_selection_small: "Shift Param Up (selection range, fine step)",
    kb_pianoroll_shift_param_down_selection_small: "Shift Param Down (selection range, fine step)",
    ...
    render_cache_summary_line: "Using {size} · {n} entries · {hits}/{total} reused this session",
    render_cache_location_label: "Cache location",
    render_cache_open_dir: "Open Folder",
    render_cache_refresh: "Refresh",
    render_cache_dir_not_writable:
        "Cache folder is not writable: this session will use in-memory caching only.",
    ...
    render_cache_write_immediate: "As soon as rendering finishes (recommended)",
    render_cache_write_on_exit: "Batch write when the app exits",
    render_cache_write_manual: "Only when saving the project",
    render_cache_location_mode: "Location",
    render_cache_location_system: "App cache folder (recommended)",
    render_cache_location_custom: "Custom folder",
    render_cache_custom_dir_placeholder: "Absolute path of the custom cache folder",
    render_cache_verify_checksum: "Verify integrity on read (corrupt entries are re-rendered)",
    render_cache_save_settings: "Save Settings",
    render_cache_settings_saved: "Settings saved",
    render_cache_settings_save_failed: "Failed to save settings",
    render_cache_clear_all: "Clear All",
    render_cache_clear_project: "Clear Current Project",
    render_cache_clear_old: "Clear Expired",
    render_cache_clear_other_rates: "Clear Other Sample Rates",
    render_cache_confirm_clear_all:
        "Clear the entire render cache? The next project open will need to render again.",
    render_cache_confirm_yes: "Clear",
    render_cache_cleared: "Cleared {n} entries, freed {size}",
