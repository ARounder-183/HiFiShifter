export const enUS = {
    ...
    // VST 插件宿主
    vst_fx: "FX",
    vst_chain_editor_title: "VST FX Chain",
    vst_scan_plugins: "Scan Plugins",
    vst_scanning: "Scanning...",
    vst_add_plugin: "Add Plugin",
    vst_remove_plugin: "Remove",
    vst_bypass: "Bypass",
    vst_open_editor: "Open Editor",
    vst_no_plugins: "No plugins found. Click Scan to search.",
    vst_empty_chain: "No effects in chain. Click + to add.",
    vst_plugin_browser_title: "VST Plugin Browser",
    vst_format: "Format",
    vst_vendor: "Vendor",
    vst_category: "Category",
    vst_path: "Path",
    vst_not_available: "VST host not available",
    vst_add_scan_path: "Add Scan Path",
    ...
    vst_manage_scan_paths: "Manage Scan Paths",
} as const;
