export const enUS = {
    ...
    notebook_clip_missing_payload: "The staged payload is missing (attachment deleted). Restore and insert are unavailable.",
    ...
    notebook_crash_hint: "Your notes are safe. Open the Markdown source view to read or copy them, or close the panel and try again.",
    notebook_crash_open_source: "Open Markdown source",
    notebook_image_insert_failed: "Failed to insert the image",
    notebook_image_missing_hint: "The attachment file is missing. Undo the deletion, or insert the image again.",
    notebook_image_copy: "Copy image",
    notebook_image_save_as: "Save image as...",
    notebook_image_reveal: "Show in file manager",
    ...
    notebook_attachments_reveal: "Show in file manager",
    ...
    notebook_setting_image_storage_sidecar: "Copy next to project",
    notebook_setting_image_storage_embed: "Embed in project file",
    notebook_setting_image_storage_link: "Link original file",
    notebook_setting_image_storage_hint: "Dragging a file keeps its path, so linking works there; images picked from a dialog are always copied.",
    ...
    notebook_setting_export_image_mode: "Export images as",
    notebook_setting_export_copy_folder: "Copy to a folder",
    notebook_setting_export_embed: "Embed in the document",
