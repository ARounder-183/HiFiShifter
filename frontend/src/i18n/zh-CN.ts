export const zhCN = {
    ...
    import_project_tempo_map: "导入速度轨（仅当前工程无速度轨时）",
    ...
    quick_export_title: "快速导出选中切片",
    quick_export_description: "只导出当前选中的 {n} 个切片。",
    ...
    quick_export_error_no_clips: "请至少选择一个切片。",
    ...
    split_transition_duration_percent_hint: "百分比按分割后前后两个 Clip 的全长合计折算。",
    ...
    split_transition_overlap_hint:
        "延伸重叠会分别向后、向前延长前后两个音频块 X 秒，形成 2X 秒的重叠区域；延伸范围会被钳制在 Clip 原素材的实际长度范围内。",
    snap: "吸附",
    ...
    snap_grid_adjust_clips_on_swing: "调整 Swing 时自动重新对齐所有 Clip",
    ...
    snap_section_interactions: "Clip 与特殊交互",
    snap_clip_edges: "吸附 Clip 起点/终点",
    snap_clip_snap_offset: "吸附 Clip 内容起点（snap offset）",
    clip_snap_offset: "吸附偏移（拖动调整）",
    snap_across_tracks: "允许跨轨道吸附 Clip",
    snap_track_distance: "跨轨距离",
    snap_razor_edits: "剃刀编辑吸附",
    snap_section_advanced: "高级",
    snap_project_sample_rate: "吸附到工程采样率",
    snap_source_edges: "Clip 边缘吸附到源素材首尾（循环节）",
    ...
    recording_auto_stop_selection: "播放到选中片段末尾自动停止",
