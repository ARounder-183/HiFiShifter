export const zhCN = {
    ...
    // VST 插件宿主
    vst_fx: "FX",
    vst_chain_editor_title: "VST 效果链",
    vst_scan_plugins: "扫描插件",
    vst_scanning: "扫描中...",
    vst_add_plugin: "添加插件",
    vst_remove_plugin: "移除",
    vst_bypass: "旁通",
    vst_open_editor: "打开编辑器",
    vst_no_plugins: "未找到插件，点击扫描以搜索。",
    vst_empty_chain: "效果链为空，点击 + 添加效果器。",
    vst_plugin_browser_title: "VST 插件浏览器",
    vst_format: "格式",
    vst_vendor: "厂商",
    vst_category: "类别",
    vst_path: "路径",
    vst_not_available: "VST 宿主不可用",
    vst_add_scan_path: "添加扫描路径",
