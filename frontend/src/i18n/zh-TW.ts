...
export const zhTW = {
    ...
    kb_group_mod_clip: "修飾鍵 · 音訊片段選取與拖拽",
    ...
    kb_modifier_copy_drag: "複製拖動（拖動音訊片段主體時按住）",
    ...
    snap_section_interactions: "Clip 與特殊互動",
    snap_clip_edges: "吸附 Clip 起點/終點",
    snap_clip_snap_offset: "吸附 Clip 內容起點（snap offset）",
    clip_snap_offset: "吸附偏移（拖動調整）",
    snap_across_tracks: "允許跨軌吸附 Clip",
    ...
    recording_auto_stop_selection: "播放到選取片段末尾自動停止",
    ...
    recording_mode_loopback: "系統音效（回圈）",
    recording_mode_application: "應用程式音訊",
    recording_loopback_device: "回圈裝置",
