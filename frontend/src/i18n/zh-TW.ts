...
export const zhTW = {
    ...
    // VST 外掛宿主
    vst_fx: "FX",
    vst_chain_editor_title: "VST 效果鏈",
    vst_scan_plugins: "掃描外掛",
    vst_scanning: "掃描中...",
    vst_add_plugin: "新增外掛",
    vst_remove_plugin: "移除",
    vst_bypass: "旁通",
    vst_open_editor: "開啟編輯器",
    vst_no_plugins: "未找到外掛，請點擊掃描以搜尋。",
    vst_empty_chain: "效果鏈為空，點擊 + 新增效果器。",
    vst_plugin_browser_title: "VST 外掛瀏覽器",
    vst_format: "格式",
    vst_vendor: "廠商",
    vst_category: "類別",
    vst_path: "路徑",
    vst_not_available: "VST 宿主不可用",
    vst_add_scan_path: "新增掃描路徑",
